...
public class ZombieUtil {
    ...
    // move speed
	public static final float WALK_SUPER_SLOW = 0.09F;
	public static final float WALK_HUGE_SLOW = 0.11F;
	public static final float WALK_VERY_SLOW = 0.13F;
	public static final float WALK_SLOW = 0.15F;
	public static final float WALK_LITTLE_SLOW = 0.18F;
