...
public class ItemRegister {
    ...
    public static final RegistryObject<Item> NUT = ITEMS.register("nut", PVZMiscItem::new);
  	...
  	public static final RegistryObject<Item> BLUE_FLAME_PEA = ITEMS.register("blue_flame_pea", PVZMiscItem::new);
    ...
    public static final RegistryObject<Item> Core_Iron = ITEMS.register("core_iron", ForProjectE::new);
    public static final RegistryObject<Item> Core_Diamond = ITEMS.register("core_diamond", ForProjectE::new);
    public static final RegistryObject<Item> Ancient_Blazing_Chrome = ITEMS.register("ancient_blazing_chrome", ForProjectE::new);
...
//  	public static final RegistryObject<Item> BOWLING_GLOVE = ITEMS.register("bowling_glove", BowlingGloveItem::new);
  	public static final RegistryObject<Item> SUN_STORAGE_SAPLING = ITEMS.register("sun_storage_sapling", () -> new SunStorageSaplingItem(7500));
  	public static final RegistryObject<Item> SMALL_SUN_STORAGE_SAPLING = ITEMS.register("sun_storage_sapling2", () -> new SunStorageSaplingItem(2000));
  	public static final RegistryObject<Item> LARGE_SUN_STORAGE_SAPLING = ITEMS.register("sun_storage_sapling3", () -> new SunStorageSaplingItem(25000));
