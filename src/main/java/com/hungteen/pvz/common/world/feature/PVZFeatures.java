...
public class PVZFeatures {
	...
	public static final BlockClusterFeatureConfig CHOMPER_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockRegister.CHOMPER.get().defaultBlockState()), new SimpleBlockPlacer())).tries(32).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).noProjection().build();
	...
	public static final ConfiguredFeature<?, ?> PATCH_CHOMPER_PLANT = register("patch_chomper_plant", Feature.RANDOM_PATCH.configured(CHOMPER_CONFIG).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).chance(8));
